...
* @类名: CompressPicture 
* @描述: TODO(压缩图片) 
* @作者: 朱俊亮  引自CSDN帖子http://blog.csdn.net/binyao02123202/article/details/8889861?reload
* @日期: 2014-4-4 下午04:18:33  
*/
/***
 ...
 */  
 public class CompressPicture {   
    ...
    public static void main(String[] arg) {   
        ...
        System.out.println("输入的图片大小：" + mypic.getPicSize("e:\\4.gif")/1024 + "KB");   
...
//            mypic.compressPic(file, "e:\\test\\", "r4.jpg", 120, 120, true);   
            ...
            count += re; System.out.println("第4张图片压缩处理使用了: " + re + "毫秒");   
            System.out.println("输出的图片大小：" + mypic.getPicSize("e:\\test\\r4.jpg")/1024 + "KB");   
